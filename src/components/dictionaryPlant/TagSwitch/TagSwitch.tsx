...
import type { TagVariantType } from "@/components/common/Tag/Tag";

import { useState } from "react";
import InlineRadio from "@/components/common/InlineRadio/InlineRadio";
    ...
    <TagBox alignment="column" contentDirection="row" width="100%">
      ...
      {typeof selectedOptions === "string" ? (
        ...
        selectedOptions.map((content) => (
          <TagBox.Content key={content}>{content}</TagBox.Content>
        ))
      )}
    </TagBox>
  );
